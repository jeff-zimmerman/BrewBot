...
print(t)
for i in range(7):
  t.insertWaypoints(Waypoint(Placement(Vector(0,0,i*100+500),Vector(1,0,0),0),"LIN","Pt"), velocity = 2000, acceleration = 100, cont = true)
...
for i in range(10):
  t.insertWaypoints(Waypoint(Placement(Vector(50,1000,i*200+500),Vector(1,0,0),i),"LIN","Pt")
